  ...
  <body>
    ...
    <div class="container">
      <div class="wrapped">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="#">Lista de asistencia</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de asistencia</h5>
                  </div>
                </div>
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Tics Tacs</td>
                          <td> 
                            <div class="text-center"><a href="#asistencia" data-toggle="modal"><i class="fa fa-file"></i></a></div>
                          </td>
                          <td> 
                            <div class="text-center"><a href="#notas" data-toggle="modal"><i class="fa fa-file"></i></a></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="control-group">
                    <div class="controls margin_bottom text-center margin_bottom"><a class="btn btn-danger btn-w-m" href="#" data-toggle="modal"><i class="fa fa-undo margin"></i>Restablecer</a></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal inmodal fade" id="notas" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal inmodal fade" id="asistencia" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-folder modal-icon"></i>
        ...
        <div class="modal inmodal fade" id="extracto" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-folder modal-icon"></i>
        ...
        <div class="modal inmodal fade" id="aportes" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-folder modal-icon"></i>
