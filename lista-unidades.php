      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de unidades por módulos </h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista de unidades por módulos </a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de unidades por módulos </h5>
                  </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Pericon</td>
                          <td>
                            <div class="text-center"><a href="#editar-unidad" data-toggle="modal"><i class="fa fa-pencil-square"></i></a></div>
                          </td>
                          <td>
          ...
          <div class="wrapper wrapper-content fadeInRight">
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase margin"></i> Lista de unidades por módulos deshabilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="text-center"><a href="#"><span class="fa fa-file"></span></a></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="control-group">
                    <div class="controls text-center margin_bottom"><a class="btn btn-info btn-w-m button" href="#" data-toogle="modal"><i class="fa fa-check margin"></i>Guardar Cambios</a><a class="btn btn-danger btn-w m" href="#" data-toogle="modal"><i class="fa fa-undo margin"></i>Restablecer</a></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="modal inmodal" id="nueva-unidad" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Nueva Unidad</h4><small class="font-bold">Llene correctamente todos los datos de la unidad</small>
              </div>
              <div class="modal-body">
                <div class="text-center">
                  <h3 class="m-t-none m-b">|  Datos de la unidad</h3>
                </div>
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      <div class="form-group">
                        ...
                        <select class="chosen-select" data-placeholder="selecionar módulo" tabindex="2">
                          <option value="">Código Módulo</option>
                          <option value="REc-12">REc-12</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Ingrese Código" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Docente</label>
                    <select class="chosen-select" data-placeholder="Nombre Docente" tabindex="2">
                      <option value="">Nombre Docente</option>
                      <option value="Pericon">Pericon</option>
                    </select>
                  </div>
                </form>
              </div>
        ...
        <div class="modal inmodal" id="editar-unidad" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-newspaper-o modal-icon"></i>
                <h4 class="modal-title">Editar Unidad</h4><small class="font-bold">Llene correctamente todos los datos de la unidad</small>
              </div>
              <div class="modal-body">
                <div class="text-center">
                  <h3 class="m-t-none m-b">|  Datos de la unidad</h3>
                ...
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label>Unidad</label>
                    <input class="form-control" placeholder="Nombre unidad" type="text">
                  </div>
                  <div class="form-group">
                    <label>Fecha</label>
                    <div class="input-group date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input class="form-control" placeholder="Nombre Docente" type="text">
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <select class="chosen-select" data-placeholder="Nombre Docente" tabindex="2">
                          <option value="">Nombre Docente</option>
