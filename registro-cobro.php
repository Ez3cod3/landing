          ...
          <nav class="navigation">
            <div class="row">
              <div class="col-sm-4 col-md-4">
                <input class="menu-trigger-input" type="checkbox" id="menu-trigger"><a class="site-logo" href="index.php" title="Funde | FDE"><img class="margin" src="images/icons/logo funde.jpg" width="auto" alt="Logo Funde | FDE"></a>
              </div>
    ...
    <div class="container">
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="#">Registro cobros</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i>Registro Cobros</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    ...
                    <div class="control-group">
                      <div class="controls margin_bottom text-center margin_bottom text-center"><a class="btn btn-success btn-w-m button" data-toggle="modal" href="#nuevo-recibo"><i class="fa fa-user-plus margin"></i>Nuevo Recibo</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="wrapper wrapper-content fadeInRight">
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i>Registro pagos egresos</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    ...
                    <div class="control-group">
                      <div class="controls margin_bottom text-center margin_bottom text-center"><a class="btn btn-success btn-w-m button" data-toggle="modal" href="#egresos"><i class="fa fa-user-plus margin"></i>Nuevo Recibo</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal inmodal" id="nuevo-recibo" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Editar datos del recibo</h4><small class="font-bold">Llene correctamente todos los datos del recibo</small>
                </div>
                <div class="modal-body">
                  ...
                  <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="6554" type="text">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="Ingrese monto" type="text">
                    </div>
                    <div class="form-group">
                      <label>Por concepto de:</label>
                      <textarea class="form-control" placeholder="Detalle factura" type="text"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Tipo Moneda</label>
                      <div class="form-inline">
                        <label class="margin">
                          <input class="i-checks margin" type="checkbox">Bs.
                        </label>
                        <label class="margin">
                          <input class="i-checks margin" type="checkbox">$us
                        </label>
                      </div>
                    </div>
                    <div class="form-group">
                      <label>Lugar</label>
                      <input class="form-control" placeholder="Lugar" type="text">
                    </div>
                    <div class="form-group">
                      <label>Fecha</label>
                      <input class="form-control" placeholder="Ingrese fecha" type="mail">
                    </div>
                    <div class="form-group">
                      <label>Cajera
                        <input class="form-control" placeholder="Isabel" type="text">
                      </label>
                    </div>
                    <div class="modal-footer">
                      <div class="text-center"><a class="btn btn-danger" href="#recibo" data-toggle="modal">Imprimir </a>
          ...
          <div class="modal inmodal" id="recibo" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                  <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-money modal-icon"></i>
                  <h4 class="modal-title">Recibo Ingreso</h4>
                </div>
                <div class="modal-body">
                  <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                      <div class="text-center">
                        <input class="menu-trigger-input" type="checkbox" id="menu-trigger"><a href="index.php" title="Funde | FDE"><img src="images/icons/logo funde.jpg" width="190" alt="Logo Funde | FDE"></a>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"></div>
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                      <h1 class="font-bold text-center letter letter_style-h1-small margin-left">Bs. 230</h1>
                    </div>
                    <div class="text-center">
                      <h3 class="margin-bottom">RECIBO DE INGRESOS</h3>
                    </div>
                  </div>
                  <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group margin-top">
                      <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <label><b> Recibí de:</b></label>
                        </div>
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                          <div class="text-center">
                            <p>Isabel Lopez Trigo</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <label><b>La suma de:</b></label>
                        </div>
                        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                          <div class="text-center">
                            <p>Docientos treinta Bs.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <label><b>Recibí Conforme:</b></label>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <p>Rina Wallet</p>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <label><b>Entregué Conforme:</b></label>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                          <p>Isabel Lopez Trigo</p>
                        </div>
          ...
          <div class="modal inmodal" id="egresos" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                  <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-money-plus modal-icon"></i>
                ...
                <div class="modal-body">
                  ...
                  <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin-left" type="checkbox">1. Transpote (Travel)
                            </label>
                          </div>
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin" type="checkbox">2. Alimentación (Food)
                            </label>
                          </div>
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin" type="checkbox">3. Refrigerios (Snacks)
                            </label>
                          </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin-left" type="checkbox">4. Hotel (Accommodations)
                            </label>
                          </div>
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin" type="checkbox">5. Limpieza (Cleaning)
                            </label>
                          </div>
                          <div class="form-inline">
                            <label class="margin">
                              <input class="i-checks margin" type="checkbox">6. Mantenimiento de Equipos (Equipment Maintenance)
                            </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      <div class="form-inline">
                        <label class="margin">
                          <input class="i-checks margin-left" type="checkbox">7. Otros (Others)
                        </label>
                      </div>
                      <div class="form-inline">
                        <label class="margin">
                    ...
                    <div class="modal-footer">
                      <div class="text-center"><a class="btn btn-danger" href="#recibo-egresos" data-toggle="modal">Imprimir </a>
                        <button class="btn btn-success">Guardar Datos</button>
                      </div>
                    </div>
                  </form>
          ...
          <div class="modal inmodal" id="recibo-egresos" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                  <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-money modal-icon"></i>
                  <h4 class="modal-title">Recibo Egresos</h4>
                </div>
                <div class="modal-body">
                  <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                    ...
                    <div class="text-center">
                      <h3 class="margin-bottom">RECIBO DE EGRESOS</h3>
                    </div>
                  </div>
                  <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group margin-top">
