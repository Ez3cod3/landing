      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de rol del sistema</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Listado de los roles del sistema</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Listado de los roles del sistema</h5>
                  </div>
                </div>
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> 
                            <div class="text-center"><a href="#" id="1"><i class="fa fa-pencil-square-o"></i></a></div>
                          </td>
                          <td> 
                            <div class="text-center"><a href="#" id="1"><i class="fa fa-times"></i></a></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="control-group">
                    <div class="controls text-center"><a class="btn btn-success btn-w-m margin_bottom" href="#new_rol" data-toggle="modal"><i class="fa fa-plus margin"></i>Nuevo</a></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="modal inmodal" id="new_rol" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content animated bounceInRight">
                  <div class="modal-header">
                    ...
                    <h3 class="modal-title">Nueva rol de usuario</h3>
                  </div>
                  <div class="modal-body">
                    <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Rol</label>
                        <input class="form-control" type="text" name="formulario" id="formulario" required placeholder="Ingrese nombre rol">
                      </div>
                      <div class="form-group">
                        <label>Descripción</label>
                        <textarea class="form-control" name="url-form" id="des_func" required rows="3" placeholder="Ingrese la descripción de un rol"></textarea>
                      </div>
                    </form>
                  </div>
