      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Listado de usuarios administrativos</h5>
                  </div>
                </div>
                          ...
                          <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                            <thead>
                              <tr role="row">
                                ...
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Nombre usuario<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Rol<span class="footable-sort-indicator"></span></th>
          ...
          <div class="panel panel-danger">
            <div class="panel-heading"><i class="fa fa-user"></i>Lista de usuario deshabilitados</div>
