  ...
  <body>
    ...
    <div class="container">
      <div class="wrapped">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="#">Lista de módulos </a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de módulos </h5>
                  </div>
                </div>
        ...
        <div class="modal inmodal" id="nuevo-modulo" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-folder-plus modal-icon"></i>
                <h4 class="modal-title">Nuevo Módulo</h4><small class="font-bold">Llene correctamente todos los datos del nuevo módulo</small>
              </div>
              <div class="modal-body">
                ...
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <select class="chosen-select" data-placeholder="Código M" type="text">
                  ...
                  <div class="form-group">
                    <label>Módulo</label>
                    <input class="form-control" placeholder="Ingrese nombre del módulo" type="text">
                  </div>
                  <div class="form-group">
                    <label>Fecha</label>
