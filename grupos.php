      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de grupos habilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    <div class="dataTables_wrapper form-inline dt-bootstrap" id="dataTables-example_wrapper">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="dataTables_length" id="dataTables-example_length">
                            <label>Mostrar
                              <select class="form-control input-sm" name="dataTables-example_length" aria-controls="dataTables-example">
                        ...
                        <div class="col-sm-6">
                          <div class="dataTables_filter" id="dataTables-example_filter">
                            <label>Buscar: 
                              <input class="form-control input-sm" placeholder="" size="8" type="search" aria-controls="dataTables-example">
                            </label>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-12">
                          <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                            <thead>
                              <tr role="row">
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">#<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Sigla<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Nombre Programa<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Versión<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Departamento<span class="footable-sort-indicator"></span></th>
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Información del grupo<span class="footable-sort-indicator"></span></th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td>1</td>
                                <td>rec-123</td>
                                <td>Mestria Educacion superior</td>
                                <td>Cochabamba</td>
                                <td> </td>
                                <td> </td>
                              </tr>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="dataTables_info" id="dataTables-example_info" role="status" aria-live="polite">Mostrando 1 a 10 de 10  Registros</div>
                        </div>
                        <div class="col-sm-6">
                          <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                            <ul class="pagination">
                              <li class="paginate_button previous disabled" id="dataTables-example_previous" aria-controls="dataTables-example" tabindex="0"><a href="#">Anterior</a></li>
                              <li class="paginate_button active" aria-controls="dataTables-example" tabindex="0"><a href="#">1</a></li>
                              <li class="paginate_button next disabled" aria-controls="dataTables-example" id="dataTables-example_next" tabindex="0"><a href="#">Siguiente</a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group">
                      <div class="controls"><a class="btn btn-success btn-sm" href="#new_" data-toogle="modal"><i class="fa fa-user-plus"></i>Nuevo Grupo</a><a class="btn btn-info btn-sm" href="#" data-toogle="modal"><i class="fa fa-check"></i>Guardar Cambios</a><a class="btn btn-primary btn-sm" href="#" data-toogle="modal"><i class="fa fa-undo"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="panel panel-danger">
            <div class="panel-heading"><i class="fa fa-user"></i>Lista de docentes deshabilitados</div>
            <div class="panel-body">
              <form method="post" action="" accept-charset="utf-8">
                <div class="table-responsive">
                      ...
                      <div class="col-sm-12">
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                          <thead>
                            <tr role="row">
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">#<span class="footable-sort-indicator"></span></th>
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Codigo<span class="footable-sort-indicator"></span></th>
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Nombre docente<span class="footable-sort-indicator"></span></th>
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Descripción<span class="footable-sort-indicator"></span></th>
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Habilitar<span class="footable-sort-indicator"></span></th>
                              <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Información usuario<span class="footable-sort-indicator"></span></th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td>79870765</td>
                              <td>Katty Delia Rojs</td>
                              <td>Docente de Tic Tacs</td>
                              <td> </td>
                              <td> </td>
                            </tr>
                          </tbody>
                  ...
                  <div class="control-group">
                    <div class="controls"><a class="btn btn-info btn-sm" href="#" data-toogle="modal"><i class="fa fa-check"></i>Guardar Cambios</a><a class="btn btn-primary btn-sm" href="#" data-toogle="modal"><i class="fa fa-undo"></i>Restablecer</a></div>
                  </div>
                </div>
              </form>
            </div>
