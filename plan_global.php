      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Plan global por programas</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Planes globales por programas</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Planes globales por programas habilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                          ...
                          <th>Eliminar
                            <tbody>
                              <tr>
                                ...
                                <td>Licenciatura</td>
                                <td> 
                                  <div class="text-center"><a href="#"><span class="fa fa-folder"></span></a></div>
                                </td>
                                <td> 
                                ...
                                <td> 
                                  <div class="text-center"><a href="#"><span class="fa fa-newspaper-o"></span></a></div>
                                </td>
                                <td> 
                    ...
                    <div class="control-group">
                      <div class="controls text-center margin_bottom"><a class="btn btn-success btn-w-m margin" href="#new_" data-toggle="modal"><i class="fa fa-user-plus margin"></i>Nuevo Plan Global</a><a class="btn btn-info btn-w-m margin" href="#" data-toggle="modal"><i class="fa fa-check margin"></i>Guardar Cambios</a><a class="btn btn-primary btn-w-m" href="#" data-toggle="modal"><i class="fa fa-undo margin"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Planes globales por programas deshabilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    ...
                    <div class="control-group">
                      <div class="controls text-center margin_bottom"><a class="btn btn-info btn-w-m margin" href="#" data-toogle="modal"><i class="fa fa-check margin"></i>Guardar Cambios</a><a class="btn btn-primary btn-w-m" href="#" data-toogle="modal"><i class="fa fa-undo margin"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
