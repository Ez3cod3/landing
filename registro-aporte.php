      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de registro aportes</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista de registro</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i>Lista de registro</h5>
                  </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> 
                            <div class="text-center"><a class="btn-w-m" href="#aporte-grupo" data-toggle="modal" width="50px"><i class="fa fa-money"></i></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a class="btn-w-m" href="#aporte-individual" data-toggle="modal" width="50px"><i class="fa fa-money"></i></a></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
        ...
        <div class="modal inmodal fade" id="aporte-individual" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal inmodal fade" id="aporte-grupo" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-folder modal-icon"></i>
