		...
		<div class="modal-dialog-md">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<a href="lista-participantes-docente.php?coduni=<?php echo $id; ?>" class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></a><i class="fa fa-user-plus modal-icon"></i>
                  ...
                  <tr>
					...
					<div class="modal-footer">
						<div class="text-center">
							...
							<a href="lista-participantes-docente.php?coduni=<?php echo $id; ?>" class="btn btn-danger btn-w-m"> Salir</a>
						</div>
					</div>
				</div>
			</div>
