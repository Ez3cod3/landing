<?php
  ...
  $conexion=Conectar();
  $consulta="select * from nota where ID_NOTA='$id' ";
  
  $query=mysqli_query($conexion, $consulta);
  
  $dato=mysqli_fetch_array($query);
  
  if(isset($_REQUEST['upd_nota'])){
    $pri=$_REQUEST['primer'];
    ...
    if($_FILES['img_func']['name']=="")
    {
      ...
      $consulta1="UPDATE nota SET PRI_PARCIAL = '".$pri."', SEG_PARCIAL='".$seg."', FINAL= '".$fin."', RECUPERATORIO = '".$rec."' WHERE ID_NOTA = '".$id."'";
      $query1=mysqli_query($conexion, $consulta1);
      header("Location:participante-nota.php?id=$uni");
    }
    else
    {
    ...
    <div class="modal-dialog">
      <div class="modal-content animated bounceInRight">
        <div class="modal-header">
          <a class="close" href="participante-nota?id=$uni.php" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></a><i class="fa fa-folder-plus modal-icon"></i>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <label>Nota 1er Parcial</label>
                  
                  <input type="text" class="form-control" name="primer" >
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <label>Nota 2do Parcial</label>
                  <input type="text" class="form-control" name="segundo" >
                </div>
              </div>
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="modal-footer">
              <div class="text-center">
                <div class="controls margin_bottom text-center margin_bottom">
                  <button class="btn btn-success btn-w-m button" name="upd_nota" type="submit">Guardar Datos</button>
                  <a class="btn btn-info btn-w-m button" href="participante-nota.php?id=$uni">Cancelar</a>
                </div>
              </div>  
              </div>
            </div>
