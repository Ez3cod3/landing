      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de calificaciones de los participantes</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista calificaciones</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de asistencia de participantes </h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                        ...
                        <tr>
                          ...
                          <td> 
                            <div class="text-center">
                              <input class="form-control" placeholder="Detalle" type="text">
                            </div>
                          </td>
                          <td>
                            <div class="text-center">
                              <input class="form-control" placeholder="Nota" type="text">
                            </div>
                          </td>
                          <td>12/12/12</td>
                        </tr>
                    ...
                    <div class="control-group">
                      <div class="controls text-center margin_bottom"><a class="btn btn-info btn-w-m button" href="#nueva-nota" data-toggle="modal"><i class="fa fa-plus margin"></i>Nueva Nota</a><a class="btn btn-danger btn-w-m button" href="#" data-toggle="modal"><i class="fa fa-plus margin"></i>Guardar</a></div>
                    </div>
                  </div>
                </div>
                <div class="modal inmodal" id="nueva-nota" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content animated bounceInRight">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nuevo Calificación</h4><small class="font-bold">Llene correctamente todos los datos de la calificación</small>
                      </div>
                      <div class="modal-body">
                        <div class="text-center">
                          <h3 class="m-t-none m-b">|  Calificaciones</h3>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                              <div class="form-group">
                                <label>Unidad</label>
                                <select class="chosen-select" data-placeholder="Nombre Unidad" tabindex="2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                              <div class="form-group">
                                <label>Nota</label>
                                <input class="form-control" placeholder="Detalle de calificación" type="text">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <label>Detalle</label>
                            <input class="form-control" type="text" placeholder="Detale de la nota">
                          </div>
                        </form>
                      </div>
