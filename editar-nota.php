<?php
	...
	$id=$_REQUEST['id'];
	$conexion=Conectar();
	$consulta="select * from funcion where id_fun='$id'";
		...
		<div class="modal-dialog-lg">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<a class="close" type="button" href="participante-nota.php?id=<?php echo $id?>" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></a><i class="fa fa-newspaper-o modal-icon"></i>
					<h4 class="modal-title">Editar Notas</h4><small class="font-bold">Llene correctamente todos los datos</small>
				</div>
				<div class="modal-body">
					<div class="text-center">
						<h3 class="m-t-none m-b">| Lista Notas</h3>
					</div>
										...
										<table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
											...
											<tbody>
												<?php
													...
													$conexion = Conectar();
													$cont=0;
													$consulta1="select * from usuario as us, matricula as ma, programa as pro, modulo as md, unidad as un where  us.CI_USER = ma.CI_USER and pro.COD_PROGRA = ma.COD_PROGRA and pro.COD_PROGRA = md.COD_PROGRA and md.COD_MOD = un.COD_MOD and un.COD_UNI = '$id1'";
													$query1=mysqli_query($conexion, $consulta1);
													$identi=0;
														...
														<tr>
															...
															<td>
																<div class='controls text-center'>
																	<a class='btn btn-info btn-w-m button' href='crear_nota.php?coduni=".$dato["COD_UNI"]."&matri=".$dato["MATRICULA"]."&coduser=".$dato["CI_USER"]."' type='submit'><i class='fa fa-check'></i>Editar Nota</a>
																</div>
															</td>	
														</tr>";
													}
