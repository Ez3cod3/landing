          ...
          <div class="ibox-content">
            <form class="m-t formulario" role="form" action=login.php>
              ...
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Ingrese su matricula" name="cod_reg" id="cod_reg">
              </div>
              <div class="form-group">
                <input class="form-control" type="text" placeholder="Ingrese su C.I." name="ci_user" id="ci_user">
              </div>
              <div class="text-center">
                <button class="btn button" type="submit">Ingresar</button>
                <p class="text-muted text-center"> <small>Registrarse</small></p><a class="btn btn-sm btn-white btn-block" href="registro.php">Crear registro nuevo</a>
              </div>
            </form>
          </div>
        </div>
