      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de formulario por función</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Listado de formularios del sistema por función</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Listado de formularios del sistema por función</h5>
                  </div>
                </div>
                <div class="ibox-content">
                          ...
                          <th>Eliminar
                            <tbody>
                              <tr>
                                ...
                                <td>list-pg.php</td>
                                <td> 
                                  <div class="text-center"><a class="btn btn-w-s" href="#"><span class="fa fa-times"></span></a></div>
                                </td>
                              </tr>
                            </tbody>
                          </th>
                  ...
                  <div class="control-group">
                    <div class="controls text-center"><a class="btn btn-success btn-w-m margin_bottom" href="#new_form-fun" data-toggle="modal"><i class="fa fa-plus margin"></i>Nuevo</a></div>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="modal inmodal" id="new_form-fun" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
