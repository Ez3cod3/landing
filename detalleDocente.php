		...
		<div class="modal-dialog-md">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<a href="plantel_docente.php" class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></a><i class="fa fa-user-plus modal-icon"></i>
					<h4 class="modal-title">Información Docente</h4>
				</div>
				<div class="modal-body">
					<table class="table table-bordered">
						<tr>
							...
							<th colspan="8">
								<div class="text-center">
									...
									<small>Información Docente</small>
								</div>
							</th>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="5">
								<p><b style="font-weight: bold;">Dirección:</b></p>
							</td>
							<td colspan="7">
								<p><?php 
									 	include_once("conexion.php");
										$conexion = Conectar();				
							            $consulta="select * from usuario where usuario.CI_USER = $cod_user";
							            $query=mysqli_query($conexion, $consulta);
							            
							            $dato1=mysqli_fetch_array($query);
							            echo $dato1["DIRECCION1"];
					...
					<div class="modal-footer">
						<div class="text-center">
							<a href="javascript:PopupCenter('imprimir-docente.php?$coduser=<?php echo $dato['CI_USER'];?>','IMPRIMIR DOCENTE',600,500)" class="btn btn-primary btn-w-m"><i class="fa fa-print"></i> Imprimir</a>
							<a href="plantel_docente.php" class="btn btn-danger btn-w-m"> Salir</a>
						</div>
					</div>
				</div>
			</div>
