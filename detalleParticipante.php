			...
			<div class="modal-content animated bounceInRight">
				...
				<div class="modal-body">
                  ...
                  <tr>
                    ...
                    <td colspan="2">
                      <p><b style="font-weight: bold;">Código Usuario:</b></p>
                    </td>
                    <td colspan="2">
                      <div class="text-center">
                        <p><?php echo $dato['COD_SIS']; ?></p>
                      </div>
                    </td>  
                  </tr>
                  <tr>
                  ...
                  <tr>
					...
					<div class="modal-footer">
						<div class="text-center">
							<a href="javascript:PopupCenter('imprimir-participante.php?$coduser=<?php echo $cod_user;?>','IMPRIMIR DOCENTE',600,500)" class="btn btn-primary btn-w-m"><i class="fa fa-print"></i> Imprimir</a>
