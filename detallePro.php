		...
		<div class="modal-dialog-md">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					<a href="lista-programas.php" class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></a><i class="fa fa-user-plus modal-icon"></i>
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
										...
										<tbody>
											...
											<tr>
												<td colspan="3"><label>Número Aportes Bs/$us</label></td>
					...
					<div class="modal-footer">
						<div class="text-center">
							...
							<a href="detallePro.php" class="btn btn-danger btn-w-m"> Salir</a>
						</div>
					</div>
				</div>
			</div>
