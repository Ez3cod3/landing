...
<html>
  ...
  <body>
    ...
    <div class="container">
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista del plantel docente</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista del plantel docente</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista del plantel docente habilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="dataTables_length" id="dataTables-example_length">
                            <label>Mostrar
                              <select class="form-control input-sm margin" name="dataTables-example_length" aria-controls="dataTables-example">
                        ...
                        <div class="col-sm-6">
                          <div class="dataTables_filter" id="dataTables-example_filter">
                            <label>Buscar: 
                              <input class="form-control input-sm margin_left" placeholder="" size="8" type="search" aria-controls="dataTables-example">
                            </label>
                          </div>
                        </div>
                      </div>
                          ...
                          <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                            <thead>
                              <tr role="row">
                                ...
                                <th class="footable-visible footable-sortable" aria-controls="dataTables-example" rowspan="1" colspan="1">Descripcion<span class="footable-sort-indicator"></span></th>
                    ...
                    <div class="control-group">
                      <div class="controls margin_bottom text-center"><a class="btn btn-success btn-w-m button" data-toogle="modal" href="#docente-registro"><i class="fa fa-user-plus"></i>Nuevo Docente</a><a class="btn btn-info btn-w-m button" href="#" data-toogle="modal"><i class="fa fa-check"></i>Guardar Cambios</a><a class="btn btn-danger btn-w-m" href="#" data-toogle="modal"><i class="fa fa-undo"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="wrapper wrapper-content fadeInRight">
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista del plantel docente deshabilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
                    <div class="dataTables_wrapper form-inline dt-bootstrap" id="dataTables-example_wrapper">
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="dataTables_length" id="dataTables-example_length">
                            <label>Mostrar
                              <select class="form-control input-sm margin margin_left" name="dataTables-example_length" aria-controls="dataTables-example">
                                <option value="10">10</option>
                                <option value="25">25</option>
                                <option value="50">50</option>
                                <option value="100">100</option>
                        ...
                        <div class="col-sm-6">
                          <div class="dataTables_filter" id="dataTables-example_filter">
                            <label>Buscar: 
                              <input class="form-control input-sm margin-left" placeholder="" size="8" type="search" aria-controls="dataTables-example">
                            </label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="control-group">
                      <div class="controls"><a class="btn btn-info btn-w-m button" href="#" data-toogle="modal"><i class="fa fa-check"></i>Guardar Cambios</a><a class="btn btn-danger btn-w m" href="#" data-toogle="modal"><i class="fa fa-undo"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="modal inmodal" id="docente-registro" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content animated bounceInRight">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Registro Docente</h4><small class="font-bold">Llene correctamente todos los datos personales del docente</small>
            </div>
            <div class="modal-body">
              <div class="text-center">
                <h3 class="m-t-none m-b">Registrar</h3>
                <form role="form">
                  ...
                  <div class="form-group">
                    <input class="form-control" placeholder="Grado academico" type="text">
                  </div>
                  <div class="form-inline">
                    <h3>Sexo</h3>
                    <label>
                      <input class="icheckbox_square-green checked" type="checkbox">Mujer
                    </label>
                    <label>
                      <input class="icheckbox_square-green checked pull-right" type="checkbox">Hombre
                    </label>
                  </div>
                </form>
              </div>
