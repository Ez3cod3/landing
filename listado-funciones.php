...
?>
		...
		<div class="container">
					...
					<div class="row wrapper border-bottom white-bg page-heading">
						<div class="col-lg-10">
							...
							<ol class="breadcrumb">
								...
								<li><a href="#">Listado de funciones del sistema</a></li>
							</ol>
						</div>
							...
							<div class="col-lg-12">
								<div class="ibox float-e-margins">
									<div class="ibox-title">
										<h5> <i class="fa fa-briefcase"></i> Listado de funciones del Sistema</h5>
									</div>
								</div>
								<div class="ibox-content">
												...
												<?php
													...
													while($dato=mysql_fetch_array($query))
													{
														...
														<tr>
															...
															<td>".$dato["NOM_FUN"]."</td>
															<td >".$dato["DESC_FUN"]."</td>
															<td><div class='text-center'><a href='upd_func.php?id=".$dato["ID_FUN"]."'><span class='fa fa-edit'></span></a></div></td>
															<td>
																<div class='text-center'>
																	<a href='del_func.php?id=".$dato["ID_FUN"]."'><span class='fa fa-times'></span></a></div></td>
														</tr>";
														}
												?>
											</tbody>
									...
									<div class="control-group">
										<div class="controls text-center"><a class="btn btn-success btn-w-m margin_bottom" href="#new_func" data-toggle="modal"><i class="fa fa-plus margin"></i>Nuevo</a></div>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="modal inmodal" id="new_func" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content animated bounceInRight">
						<div class="modal-header">
							...
							<h3 class="modal-title">Nueva Función del Sistema</h3>
						</div>
						<div class="modal-body">
							<form class="form-signin" action="configure.php" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label>Función</label>
									<input class="form-control" type="text" name="funcion" id="funcion" required placeholder="Ingrese nueva función">
								</div>
								<div class="form-group">
									<label>Descripción</label>
									<textarea class="form-control" name="des_func" id="des_func" required rows="3" placeholder="Ingrese una descripción sobre la nueva función"></textarea>
								</div>
								<div class="form-group">
									<label>Imagen</label>
									<input class="form-control" type="file" name="img_func" id="img_func">
								</div>
								<div class="modal-footer">
									<div class="text-center">
										<button class="btn btn-success btn-w-m" name="insert_func" type="input" id="insert_func"><i class="fa fa-check margin"> </i>Insertar Datos</button>
							</div>
							</form>
						</div>
