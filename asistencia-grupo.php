      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de asistencia por Módulo</h2>
              <ol class="breadcrumb">
                <li><a href="home.php">Home</a></li>
                <li><a href="#">Lista Programa</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de asistencia por Programa</h5>
                  </div>
                </div>
                        ...
                        <?php
                          ...
                          while($dato=mysqli_fetch_array($query))
                          {
                            ...
                            <tr>
                              ...
                              <td>".$dato["COD_PROGRA"]."</td>
                              <td >".$dato["DEPARTAMENTO"]."</td>
                              <td >".$dato["LOCALIDAD"]."</td>
                             
                              <td> 
                                <div class='text-center'><a href='lista-asistencia-grupo.php?id=".$dato["COD_PROGRA"]."'.php'><span class='fa fa-list'></span></a></div>
                              </td>
                              <td> 
                                <div class='text-center'><a href='lista-nota-grupo.php?id=".$dato["COD_PROGRA"]."'.php'><span class='fa fa-list'></span></a></div>
                              </td>
