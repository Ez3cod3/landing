          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="#">Listado de formularios del sistema</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Listado de formularios del sistema</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  ...
                  <div class="control-group">
                    <div class="controls text-center"><a class="btn btn-success btn-w-m margin_bottom" href="#new_formulario" data-toggle="modal"><i class="fa fa-plus margin"></i>Nuevo</a></div>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="modal inmodal" id="new_formulario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                  ...
                  <h3 class="modal-title">Nueva Formulario del Sistema</h3>
                </div>
                <div class="modal-body">
                  <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Formulario</label>
                      <input class="form-control" type="text" name="formulario" id="formulario" required placeholder="Ingrese nombre formulario">
                    </div>
                    <div class="form-group">
                      <label>URL</label>
                      <textarea class="form-control" name="url-form" id="des_func" required rows="3" placeholder="Ingrese la dirección url del formulario"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Descripción</label>
                      <textarea class="form-control" type="file" name="desc-form" id="desc-form"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Imagen</label>
                      <input class="form-control" type="file" id="imag-form" name="imag-form">
                    </div>
                  </form>
                </div>
                <div class="modal-footer">
                  <div class="text-center">
                    <button class="btn btn-success btn-w-m" name="insert_func" type="button" id="insert_func"><i class="fa fa-check margin"> </i>Ingresar Datos</button>
                  </div>
                </div>
              </div>
            </div>
