<?php
  ...
  $conexion=Conectar();
  $consulta="select * from asistencia where ID_ASIS='$iduni' ";
  ...
  if(isset($_REQUEST['upd_asis'])){
    
    $asis = $_REQUEST['asiste'];
    if($_FILES['img_func']['name']=="")
    {
      

      $consulta1="UPDATE asistencia SET ASISTIO = '".$asis."' WHERE ID_ASIS = '".$iduni."'";
      $query1=mysqli_query($conexion, $consulta1);
      header("Location:participantes-asistentes.php?id=$coduni");
    }
    else
    {
      ...
      <div class="modal-content animated bounceInRight">
        ...
        <div class="modal-body">
          <div class="text-center">
            <h3 class="m-t-none m-b">| Asistencia</h3>
          </div>
          <form class="form-signin" action="#" method="post" enctype="multipart/form-data">
            
            
            <div class="form-group">
                    <label>Seleccione Tipo de Asistencia</label>
                   <select class="chosen-select" tabindex="2" name="asiste">
            ...
            <div class="modal-footer">
              <div class="text-center">
                <div class="controls margin_bottom text-center margin_bottom">
                  <button class="btn btn-success btn-w-m button" name="upd_asis" type="submit">Guardar Datos</button>
                  <a class="btn btn-info btn-w-m button" href="participantes-asistentes?id=$iduni.php">Cancelar</a>
                </div>
              </div>  
              </div>
            </div>
