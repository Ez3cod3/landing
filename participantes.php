      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de participantes en general</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista de participantes</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de participantes</h5>
                  </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>David</td>
                          <td> 
                            <div class="text-center"><a href="#info-user" data-toggle="modal"><span class="fa fa-folder"></span></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a href="#matricular" data-toggle="modal"><span class="fa fa-drivers-license"></span></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a href="#editar-user" data-toggle="modal"><i class="fa fa-pencil-square"></i></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a href="#" data-toggle="modal"><i class="fa fa-times"></i></a></div>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <div class="control-group">
                      <div class="controls margin_bottom text-center margin_bottom"><a class="btn btn-success btn-w-m button" data-toggle="modal" href="#registro-user"><i class="fa fa-user-plus margin"></i>Nuevo participante</a><a class="btn btn-info btn-w-m button" href="#" data-toggle="modal"><i class="fa fa-check margin"></i>Guardar Cambios</a><a class="btn btn-danger btn-w-m" href="#" data-toggle="modal"><i class="fa fa-undo margin"></i>Restablecer</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal inmodal" id="registro-user" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Registro de Usuarios</h4><small class="font-bold">Llene correctamente todos los datos personales del usuario</small>
              </div>
              ...
              <div class="modal-footer">
                <div class="text-center">
                  <button class="btn btn-success">Ingresar Datos</button>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div class="modal inmodal" id="editar-user" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-user-plus modal-icon"></i>
        ...
        <div class="modal inmodal" id="info-user" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-user-plus modal-icon"></i>
        ...
        <div class="modal inmodal" id="matricular" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                <button class="close" type="button" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-drivers-license-plus modal-icon"></i>
                <h4 class="modal-title">Matricular Usuario</h4>
              </div>
              <div class="modal-body">
                <div class="text-center">
                  <h3 class="m-t-none m-b">Matricular</h3>
                </div>
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Apellido Paterno</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6">
                        <select class="chosen-select" data-placeholder="Lugar de Expedición" tabindex="2">
                          <option value="">Expedición</option>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-6 col lg-6">
                        <label>Código Matricula</label>
                        <input class="form-control" placeholder="Ingrese e-mail" type="text">
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-6 col lg-6">
                        <label>Programa</label>
                        <select class="chosen-select" data-placeholder="Programa" type="text">
                          <option value="Programa">Programa</option>
                          <option value="Tics Tacs">Tics Tacs</option>
                        </select>
                      </div>
                    </div>
                  </div>
