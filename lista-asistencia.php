      ...
      <div class="wrapped">
        <div class="gray-bg" id="page-wrapper" style="min-height:182px;">
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
              <h2>Lista de asistencia por unidad</h2>
              <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li><a href="#">Lista de asistencia por unidad</a></li>
              </ol>
            </div>
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de asistencia por unidades</h5>
                  </div>
                </div>
                <div class="ibox-content">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>65%</td>
                          <td> 
                            <div class="text-center"><a href="participantes-asistentes.php"><span class="fa fa-list"></span></a></div>
                          </td>
                          <td>Pericon</td>
                          <td>13/5/2017</td>
                        </tr>
                  ...
                  <div class="control-group">
                    <div class="controls text-center margin_bottom"><a class="btn btn-info btn-w-m button" href="#nueva-unidad" data-toggle="modal"><i class="fa fa-plus margin"></i>Nueva Unidad</a></div>
                  </div>
                </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content animated bounceInRight">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nuevo Unidad</h4><small class="font-bold">Llene correctamente todos los datos de la unidad</small>
                      </div>
