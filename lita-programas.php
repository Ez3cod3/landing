  ...
  <body>
    ...
    <div class="container">
      <div class="wrapped">
              ...
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de programas</h5>
                  </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example" id="dataTables-example">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="text-center"><a href="#documentos-programa" data-toggle="modal"><span class="fa fa-file"></span></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a href="#editar-programa" data-toggle="modal"><i class="fa fa-pencil-square"></i></a></div>
                          </td>
                          <td>
                            <div class="text-center"><a href="modulo-programa.php"><span class="fa fa-folder"></span></a></div>
                          </td>
                          <td>
          ...
          <div class="wrapper wrapper-content fadeInRight">
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox float-e-margins">
                  <div class="ibox-title">
                    <h5> <i class="fa fa-briefcase"></i> Lista de programas deshabilitados</h5>
                  </div>
                </div>
                <div class="ibox-content">
                  <div class="table-responsive">
          ...
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Nuevo Programa</h4><small class="font-bold">Llene correctamente todos los datos del programa</small>
              </div>
              <div class="modal-body">
                ...
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <label>Código</label>
                    <input class="form-control" placeholder="Ingrese Código" type="text" method="post">
                  </div>
                  <div class="form-group">
        ...
        <div class="modal inmodal" id="editar-programa" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Editar datos del programa</h4><small class="font-bold">Llene correctamente todos los datos del programa</small>
              </div>
              <div class="modal-body">
                <div class="text-center">
                  <h3 class="m-t-none m-b">|  Datos del programa</h3>
                ...
                <form class="form-signin" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input class="form-control" placeholder="Versión" type="text">
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <input class="form-control" placeholder="Costo del programa" type="text">
                      </div>
              ...
              <div class="modal-footer">
                <div class="text-center">
                  <button class="btn btn-success btn-w-m">Ingresar Datos</button>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div class="modal inmodal" id="documentos-programa" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
              <div class="modal-header">
