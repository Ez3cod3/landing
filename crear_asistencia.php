    ...
    <div class="modal-dialog">
      <div class="modal-content animated bounceInRight">
        ...
        <div class="modal-body">
          ...
          <form class="form-signin" action="asiste-unidad.php" method="post" enctype="multipart/form-data">
            
            <div class="form-group">
              <label>Unidad</label>
              <input class="form-control" name="unidad" required value="<?php echo $dato['COD_UNI']; ?>" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="modal-footer">
              <div class="text-center">
                <div class="controls margin_bottom text-center margin_bottom">
                  <button class="btn btn-success btn-w-m button" type="submit">Guardar Datos</button>
