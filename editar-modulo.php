		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
					...
					<h4 class="modal-title">Editar Diplomado</h4><small class="font-bold">Llene correctamente todos los datos del Diplomado</small>
				</div>
				<div class="modal-body">
					<div class="text-center">
						<h3 class="m-t-none m-b">| Datos Diplomado</h3>
					</div>
					<form class="form-signin" action="#" method="post" enctype="multipart/form-data">
						<div class="form-group">
                           ...
                           <?php 
                              ...
                              {?>
                              <option value="<?php echo $dato1['COD_PROGRA'];?>"><?php echo $dato1['COD_PROGRA'];?></option>
                            <?php } ?>
                        </select>
								</div>
						...
						<div class="form-group">
							...
							<input class="form-control" name="nom_m" required value="<?php echo $dato['NOM_MOD']; ?>" type="text">
						</div>
						<div class="form-group">
							<label>Fecha</label>
							<div class="input-group date"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								<input class="form-control" type="date" value="" name="fec_m">
							</div>
						</div>
						<div class="modal-footer">
							<div class="text-center">
								<div class="controls margin_bottom text-center margin_bottom">
                  <button class="btn btn-success btn-w-m button" name="upd_mod" type="submit">Actualizar Datos</button>
                  <a class="btn btn-info btn-w-m button" href="lista-modulo.php">Cancelar</a>
                </div>
              </div>	
							</div>
						</div>
